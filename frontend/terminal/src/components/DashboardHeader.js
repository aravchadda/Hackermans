...
const DashboardHeader = ({ mode, onModeChange, showChat, onToggleChat, userRole = 'admin', onClearScreen, onImportCSV, onManageViews }) => {
  return (
      ...
      <div className="flex items-center gap-3">
        ...
        {mode === "design" && (
          <button
            ...
            className="h-8 px-3 text-sm font-medium border border-purple-200 dark:border-purple-600 rounded-md hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-200 flex items-center gap-1.5 text-purple-700 dark:text-purple-300 hover:text-purple-800 dark:hover:text-purple-200"
            title="Create and manage custom views"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
